...
from helper.inputs import get_program
def compute(plan,instructor_list,course_list,student_list,uni_programs,min_load,max_load,random):
    ...
    tls= total_students_load(plan,course_list,student_list,min_load,max_load)
    tsc= total_students_courses(plan,course_list,student_list)
