...
def constraint_dominates(ind1, ind2):
    ...
    max_sems = inputs.get_max_terms()
    violation1 = constraints2.total_violation(ind1,uni_program_list=uni_program_list,student_list=students_list,max_sems=max_sems)
    violation2 = constraints2.total_violation(ind2,uni_program_list=uni_program_list,student_list=students_list,max_sems=max_sems)
