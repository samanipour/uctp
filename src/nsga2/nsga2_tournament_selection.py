import random
class ParetoTournament:
    def select(self,population, fronts, distances, tournament_size=2):
        """
        ...
        while len(selected) < len(population):
            ...
            for competitor in tournament:
                if self.is_better(competitor, best, fronts, distances):
                    best = competitor
            selected.append(population[best])

        return selected

    def is_better(self,ind1, ind2, fronts, distances):
        """
